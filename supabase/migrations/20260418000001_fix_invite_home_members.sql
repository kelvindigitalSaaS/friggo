-- =============================================================================
-- Fix: accept_invite now also adds the member to the master's home_members
-- Problem: original function only created sub_account_members, leaving the
--          subconta without a home_id → 403 on all home-scoped tables.
-- This function runs as SECURITY DEFINER to bypass home_members INSERT RLS
-- (which requires owner/admin role — the invited member doesn't have one yet).
-- =============================================================================
